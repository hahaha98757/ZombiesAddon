...
public class ZombiesAddonConfig {
	...
	public static void loadConfig() {
		...
		Property propertyShowActiveWindowsByOthers = config.get(Configuration.CATEGORY_GENERAL,
				"Show Active Windows By Others", false, "Show active windows by other players.");
