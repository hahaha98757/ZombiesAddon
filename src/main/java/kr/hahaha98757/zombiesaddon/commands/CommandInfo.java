	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (args.length == 0) {
			player.addChatComponentMessage(new ChatComponentText(LINE + "\nMod name: " + ZombiesAddon.NAME
					...
					+ "\nMod list: Cornering, Block Alarm, DPS Counter, Not Last, Auto Splits, Wave Delays, Grow Guide, ZSV, SLA, Auto Rejoin, Powerup Alarm, Boss Alarm, Grow ESP, and Gstep Guide.\nInfo: A mod that helps playing hypixel zombies.\nCommand tips: Use /info [Cornering|BlockAlarm|DPSCounter|NotLast|AutoSplits|WaveDelays|GrowGuide|ZSV|SLA|AutoRejoin|PowerupAlarm|BossAlarm|GrowESP|GstepGuide] to view mod's description.\nURL: https://github.com/hahaha98757/ZombiesAddon\n"
					+ LINE));
			return;
		}
	...
	public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
		if (args.length == 1) {
			return getListOfStringsMatchingLastWord(args,
					new String[] { "Cornering", "BlockAlarm", "DPSCounter", "NotLast", "AutoSplits", "WaveDelays", "GrowGuide", "ZSV", "SLA", "AutoRejoin", "PowerupAlarm", "BossAlarm", "GrowESP", "GstepGuide" });
		}
		return null;
	}
}
