	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (args.length == 0) {
			player.addChatComponentMessage(new ChatComponentText(LINE + "\nMod name: " + ZombiesAddon.NAME
					...
					+ "\nMod list: Cornering, Block Alarm, DPS Counter, Not Last, Auto Splits, Wave Delays, Grow Guide, ZSV, SLA, Auto Rejoin, Powerup Alarm, Boss Spawn Tracker, Grow ESP, Gstep Guide, Player Tracker, and Boss Tracker.\nInfo: A mod that helps playing hypixel zombies.\nURL: https://github.com/hahaha98757/ZombiesAddon\n"
					+ LINE));
			return;
		}
		...
		if (args.length == 1) {
			return getListOfStringsMatchingLastWord(args,
					new String[] { "Cornering", "BlockAlarm", "DPSCounter", "NotLast", "AutoSplits", "WaveDelays",
							"GrowGuide", "ZSV", "SLA", "AutoRejoin", "PowerupAlarm", "BossSpawnTracker", "GrowESP",
