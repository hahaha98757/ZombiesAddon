...
public class ZombiesAddonConfig {
	...
	public static boolean togglePlayerTracker = true;
	...
	public static void loadConfig() {
		...
		Property propertySLAVersion = config.get(Configuration.CATEGORY_GENERAL, "SLA Version", "SLAv2",
				"SLAv2 is displayed in more detail.", new String[] { "SLAv1", "SLAv2" });
		...
		Property propertyShortenedSLA = config.get(Configuration.CATEGORY_GENERAL, "Shortened SLA", true,
				"SLA is displayed shorter.(SLAv2 only)");
		shortenedSLA = propertyShortenedSLA.getBoolean();
		sla.put(propertyShortenedSLA.getName(), new ConfigElement(propertyShortenedSLA));		

		// Trackers
		Property propertyTogglePlayerTracker = config.get(Configuration.CATEGORY_GENERAL, "Player Tracker: Toggle Player Tracker", true, "Shows the location of the player.");
		...
		Property propertyPlayerTrackerRange = config.get(Configuration.CATEGORY_GENERAL, "Player Tracker: Player Tracker Range", 2.5, "It will not work for players within this range.", 0.0, 10.0);
		...
		Property propertyToggleBossTracker = config.get(Configuration.CATEGORY_GENERAL, "Boss Tracker: Toggle Boss Tracker", false, "Shows the location of the boss.");
		...
		Property propertyBossTrackerRange = config.get(Configuration.CATEGORY_GENERAL, "Boss Tracker: Boss Tracker Range", 5.0, "It will not work for bosses within this range.", 0.0, 10.0);
		...
		Property propertyToggleBossAlarm = config.get(Configuration.CATEGORY_GENERAL, "Boss Alarm: Toggle Boss Alarm",
				true, "You can know the area where the boss has spawned.");
