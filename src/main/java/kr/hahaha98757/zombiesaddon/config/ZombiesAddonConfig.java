...
public class ZombiesAddonConfig {
	...
	public static boolean checkRelease = true;
	...
	public static void loadConfig() {
		...
		boolean[] configModDefaultValue = config.get(Configuration.CATEGORY_GENERAL, "Zombies Addon: Mod Default Value",
				...
				.getBooleanList();
		boolean configcheckRelease = config.getBoolean("Zombies Addon: Check Release", Configuration.CATEGORY_GENERAL,
				true, "It check the latest releases.");
		...
		checkRelease = configcheckRelease;
