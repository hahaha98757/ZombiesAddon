	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (args.length == 0) {
			player.addChatComponentMessage(new ChatComponentText(LINE + "\nMod name: " + ZombiesAddon.NAME
					...
					+ "\nMod list: Cornering, Block Alarm, DPS Counter, NOTLAST, Auto Splits, ZSV, SLA, Advanced SLA, Auto Rejoin, Powerup Alarm, Boss Alarm, Lrod Order, Grow ESP, and Gstep Guide.\nInfo: A mod that helps playing hypixel zombies.\nCommand tips: Use /info [Cornering|BlockAlarm|DPSCounter|NOTLAST|AutoSplits|ZSV|SLA|AdvancedSLA|AutoRejoin|PowerupAlarm|BossAlarm|LrodOrder|GrowESP|GstepGuide] to view mod's description.\nURL: https://github.com/hahaha98757/ZombiesAddon\n"
					+ LINE));
			return;
		}
		...
		case "NOTLAST":
			...
			break;
		case "AutoSplits":
			text = "Name: Auto Splits\nVersion: 1.0\nCode by: thamid\nInfo: Run internal timer or LiveSplits at start of round.\nConfig: Used\nConfig: Used";
			break;
		case "ZSV":
			...
			break;
		case "SLA":
			text = "Name: SLA(Spawn Limit Action)\nVersion: 1.3\nCode by: thamid\nInfo: Display number of windows which zombie can spawn in.\nCommands: /SLA\nConfig: Used";
			break;
		case "AdvancedSLA":
		...
		case "PowerupAlarm":
			...
			break;
		case "BossAlarm":
			text = "Name: Boss Alarm\nCode by: hahaha98757\nInfo: You will know which area the boss spawned in.\nConfig: Used";
			break;
		case "LrodOrder":
