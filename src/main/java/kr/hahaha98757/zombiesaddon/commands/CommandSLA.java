...
public class CommandSLA extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (args.length >= 1) {
			if (!args[0].equals("de") && !args[0].equals("bb") && !args[0].equals("aa") && !args[0].equals("pr") && !args[0].equals("off")) {
				...
				AdvancedSLAListener.drop();
					...
					case "aa":
						...
						break;
					case "pr":
						AdvancedSLAListener.instance = new AdvancedSLAListener(4);
						Minecraft.getMinecraft().thePlayer
	...
	public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
		if (args.length == 1) {
			return getListOfStringsMatchingLastWord(args, new String[] { "de", "bb", "aa", "pr", "off" });
		}
		return null;
	}
